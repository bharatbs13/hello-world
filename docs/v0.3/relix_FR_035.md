FR-035 — Observability Signal Scope & Identity Contract
Target Version
...
 
Architecture
Platform Event Source ↓ Observability Identity Contract ↓ Telemetry / Reports / Alerts ↓ Consumers
Consumers:
* reporting framework
* alerting framework
* replay diagnostics
...
Allowed:
received ↓ validated ↓ persisted ↓ archived
received ↓ rejected
validated ↓ rejected
Prohibited:
archived ↓ persisted
...
Priority:
record-level ↓ tenant-level ↓ platform default
 
⸻
 
Recommended Indexes
