FR-040 — Telemetry UI & Operational Metrics Visualization
Target Version
...
Architecture
Telemetry Store ↓ Telemetry Query Layer ↓ Telemetry Visualization Service ↓ UI / API / CLI ↓ Users
...
Examples:
Show:
Tenant = Production Workflow = Migration Time Range = Last 24 hours
